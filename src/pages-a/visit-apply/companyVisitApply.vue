    ...
    <view v-show="!visitType">
      ...
      <u-form labelPosition="left" :model="formModel" ref="elFormUser" labelWidth="112px" class="ufrom">
        ...
        <u-form-item>
          ...
          <u-input 
            class="input-box" 
            readonly
            @click.native="goSelectCompany(2)" 
            clearable 
            type="text" 
            placeholder="请选择" 
            border="none"
      ...
      <u-form labelPosition="left" :model="formModel"ref="elFormGoods" labelWidth="112px"  class="ufrom">
        ...
        <u-form-item prop="visitPersonPhone">
          ...
          <u-input v-model="formModel.visitPersonPhone" placeholder="请填写访客手机号" border="none" inputAlign="right" clearable style="padding-right: 20rpx;" readonly/>
        </u-form-item>
        <u-form-item prop="planVisitTime" @click="startDateObj.isShow = true">
          <text slot="label">拜访日期<text class="icon_x">*</text></text>
          <u-input v-model="formModel.planVisitTime" disabled disabledColor="#ffffff" placeholder="请选择放行日期" inputAlign="right" border="none" />
    ...
    <view v-show="visitType">
      ...
      <u-form labelPosition="left" :model="authApplyInfoList" ref="elFormUser" labelWidth="112px" class="ufrom">
        ...
        <u-form-item prop="authPlanVisitTime" @click="startDateObj.isShow = true">
          <text slot="label">拜访日期<text class="icon_x">*</text></text>
          <u-input v-model="authApplyInfoList.authPlanVisitTime" disabled disabledColor="#ffffff" placeholder="请选择放行日期" inputAlign="right" border="none" />
          <u-icon slot="right" name="arrow-right" />
        </u-form-item>
      ...
      <u-form labelPosition="left" :model="ownerInfo" ref="elFormUser" labelWidth="112px" class="ufrom">
        <u-form-item label="联系人">
          <u-input v-model="contactName" border="none" inputAlign="right" clearable readonly/>
        </u-form-item>
        <u-form-item label="联系电话">
          <u-input v-model="contactPhone" border="none" inputAlign="right" clearable readonly/>
        </u-form-item>
        <u-form-item label="拜访企业" @click="goSelectCompany(2)">
        ...
        <u-form-item label="企业详细地址" prop="add">
          <u-input v-model="authCompanyInfo.address[0]" border="none" inputAlign="right" clearable readonly/>
        </u-form-item>
      </u-form>
