<template>
  <div>
    ...
    <Drawer :closable="false" v-model="showCreateReport" width="700">
        <NewReport :isForCreate="isCreateReport" :isForEdit="isEditReport" :isForShow="isShowReportDetail" :isVisible="showCreateReport" :oldData="detailData" @close="showCreateReport=false" @submit="createSuccess"></NewReport>
    </Drawer>
  </div>
...
<script>
import { allReports, getReportDetail } from '@/service/officeSystem';
import { getAreaList, getProjectList } from '@/service/landcrm';
import NewReport from '@/pages/reportList/newReport.vue'
    ...
    export default {
        ...
        methods:{
            ...
            showDetail(row){
                ...
                let dic = {creator:info.userid,id:row.id,isDrafts:0};
                let param = {
                    data:dic
                }
                let self = this
            ...
            search(){
                ...
                let self = this;
                allReports(params, this.pageSize, this.startIndex).then((res)=>{
